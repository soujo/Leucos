...
Welcome to [soujo/leucos](https://github.com/soujo/leucos). Before sending your pull requests, make sure that you **read the whole
...
* Step 2: Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/soujo/leucos.git
    ```
* Step 3: Keep your cloned repo upto date by pulling from upstream (this will also avoid any merge conflicts while committing new changes)
    ```
    git pull upstream main https://github.com/soujo/leucos.git
    ```
...
- Do not update the [README.md](https://github.com/soujo/leucos/blob/main/README.md) and [Contributing_Guidelines.md](https://github.com/soujo/leucos/blob/main/CONTRIBUTING.md).
